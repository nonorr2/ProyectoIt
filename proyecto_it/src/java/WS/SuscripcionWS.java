...
/**
 * Jersey REST client generated for REST resource:SuscripcionFacadeREST
 * [ws.suscripcion]<br>
 * USAGE:
 * <pre>
...
public class SuscripcionWS {
    ...
    public <T> T getPublicacionSuscrito_XML(GenericType<T> responseType, String idUsuario) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("getPublicacionSuscrito/{0}", new Object[]{idUsuario}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T getPublicacionSuscrito_JSON(GenericType<T> responseType, String idUsuario) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("getPublicacionSuscrito/{0}", new Object[]{idUsuario}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
